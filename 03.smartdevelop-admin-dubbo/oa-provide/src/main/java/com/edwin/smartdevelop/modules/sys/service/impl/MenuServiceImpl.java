...
import com.edwin.smartdevelop.modules.sys.mapper.MenuMapper;
 ...
 */
@Component
@Service(version = "1.0.0",timeout = 10000,interfaceClass = IMenuService.class,weight = 1)
...
public class MenuServiceImpl extends CrudService<MenuMapper,Menu> implements IMenuService  {
    ...
    //顶级菜单ID
    private static final String ZERO_MENU_ID = "1";
    ...
    public Menu getMenuTrees(List<Menu> menus) {
        ...
        //获取首个菜单
        for (Menu menu : menus) {
            if(ZERO_MENU_ID.equals(menu.getId())){
                return menu;
            }
        }
        return null;
